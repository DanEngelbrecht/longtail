...
export SRC="$BASE_DIR/shared_lib/shared_lib.cpp $BASE_DIR/src/*.c $LIB_SRC $CACHEBLOCKSTORE_SRC $COMPRESSBLOCKSTORE_SRC $FILESTORAGE_SRC $FSBLOCKSTORAGE_SRC $MEMSTORAGE_SRC $MEOWHASH_SRC $BIKESHED_SRC $BLAKE2_SRC $BLAKE3_SRC $LIZARD_SRC $LZ4_SRC $BROTLI_SRC $ZSTD_SRC"
export TEST_SRC=
