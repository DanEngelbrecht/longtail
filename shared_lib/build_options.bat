...
set SRC=%BASE_DIR%\src\*.c %LIB_SRC% %CACHEBLOCKSTORE_SRC% %COMPRESSBLOCKSTORE_SRC% %FILESTORAGE_SRC% %FSBLOCKSTORE_SRC% %MEMSTORAGE_SRC% %MEOWHASH_SRC% %BIKESHED_SRC% %BLAKE2_SRC% %BLAKE3_SRC% %LZ4_SRC% %LIZARD_SRC% %BROTLI_SRC% %ZSTD_SRC%
set MAIN_SRC=%BASE_DIR%\shared_lib\shared_lib.cpp
...
set CXXFLAGS_DEBUG=%CXXFLAGS_DEBUG% /DBIKESHED_ASSERTS /DLONGTAIL_ASSERTS /D_DEBUG /DLONGTAIL_LOG_LEVEL=3 /MDd /DLONGTAIL_VERBOSE_LOGS /D__SSE2__ /D "LONGTAIL_EXPORT=__declspec(dllexport)"
