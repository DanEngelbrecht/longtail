...
set BLAKE3_THIRDPARTY_SRC=%BASE_DIR%lib\blake3\ext\blake3.c %BASE_DIR%lib\blake3\ext\blake3_dispatch.c %BASE_DIR%lib\blake3\ext\blake3_portable.c %BASE_DIR%lib\blake3\ext\blake3_sse2.c %BASE_DIR%lib\blake3\ext\blake3_sse41.c
...
set SRC=%BASE_DIR%src\*.c %LIB_SRC% %ATOMICCANCEL_SRC% %BLOCKSTORESTORAGE_SRC% %COMPRESSBLOCKSTORE_SRC% %CACHEBLOCKSTORE_SRC% %SHAREBLOCKSTORE_SRC% %FILESTORAGE_SRC% %FSBLOCKSTORE_SRC% %HPCDCCHUNKER_SRC% %LRUBLOCKSTORE_SRC% %MEMSTORAGE_SRC% %MEMTRACER_SRC% %MEOWHASH_SRC% %RATELIMITEDPROGRESS_SRC% %COMPRESSION_REGISTRY_SRC% %HASH_REGISTRY_SRC% %BIKESHED_SRC% %BLAKE2_SRC% %BLAKE3_SRC% %LZ4_SRC% %BROTLI_SRC% %ZSTD_SRC%
...
set THIRDPARTY_SRC_SSE42=%BLAKE3_THIRDPARTY_SSE42%
