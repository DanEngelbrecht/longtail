...
rem     %1 --create-version-index "%2\remote\incremental.lvi" --version "%2\remote\incremental"
rem )

rem %1 --update-version "%2/remote/incremental" --version-index "%2/remote/incremental.lvi" --content "%2/chunks" --content-index "%2/chunks.lci" --target-version-index "%2/%3.lvi"
