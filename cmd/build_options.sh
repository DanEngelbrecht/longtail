...
export SRC="$BASE_DIR/cmd/main.cpp $BASE_DIR/src/*.c $LIB_SRC $FILESTORAGE_SRC $MEMSTORAGE_SRC $MEOWHASH_SRC $BIKESHED_SRC $BLAKE2_SRC $BLAKE3_SRC $LIZARD_SRC $BROTLI_SRC $ZSTD_SRC"
export TEST_SRC=""
export THIRDPARTY_SRC="$LIB_THIRDPARTY_SRC $BLAKE2_THIRDPARTY_SRC $BLAKE3_THIRDPARTY_SRC $LIZARD_THIRDPARTY_SRC $BROTLI_THIRDPARTY_SRC $ZSTD_THIRDPARTY_SRC"
