...
set FULL_COMPRESSION_REGISTRY_SRC=%BASE_DIR%lib\compressionregistry\longtail_full_compression_registry.c
...
set SRC=%BASE_DIR%\src\*.c %LIB_SRC% %CACHEBLOCKSTORE_SRC% %COMPRESSBLOCKSTORE_SRC% %FILESTORAGE_SRC% %FSBLOCKSTORE_SRC% %MEMSTORAGE_SRC% %MEOWHASH_SRC% %FULL_COMPRESSION_REGISTRY_SRC% %BIKESHED_SRC% %BLAKE2_SRC% %BLAKE3_SRC% %LZ4_SRC% %LIZARD_SRC% %BROTLI_SRC% %ZSTD_SRC%
set MAIN_SRC=%BASE_DIR%cmd\main.cpp
...
set CXXFLAGS_DEBUG=%CXXFLAGS_DEBUG% /D_CRTDBG_MAP_ALLOC /wd4244 /wd4316 /wd4996 /DBIKESHED_ASSERTS /DLONGTAIL_ASSERTS /D__SSE2__
rem /D /D_DEBUG /MDd
