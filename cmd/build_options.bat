...
set SRC=%BASE_DIR%cmd\main.cpp %BASE_DIR%\src\*.c %LIB_SRC% %CACHEBLOCKSTORE_SRC% %FILESTORAGE_SRC% %FSBLOCKSTORE_SRC% %MEMSTORAGE_SRC% %MEOWHASH_SRC% %BIKESHED_SRC% %BLAKE2_SRC% %BLAKE3_SRC% %LZ4_SRC% %LIZARD_SRC% %BROTLI_SRC% %ZSTD_SRC%
set TEST_SRC=
