...
Longtail_CompressionAPI_HSettings Longtail_GetLizardMinQuality() { return (Longtail_CompressionAPI_HSettings)&LizardCompressionAPI_MinCompressionSetting; }
Longtail_CompressionAPI_HSettings Longtail_GetLizardDefaultQuality() { return (Longtail_CompressionAPI_HSettings)&LizardCompressionAPI_DefaultCompressionSetting; }
Longtail_CompressionAPI_HSettings Longtail_GetLizardMaxQuality() { return (Longtail_CompressionAPI_HSettings)&LizardCompressionAPI_MaxCompressionSetting; }
