...
Longtail_CompressionAPI_HSettings Longtail_GetZStdMinQuality() { return (Longtail_CompressionAPI_HSettings)&LONGTAIL_ZSTD_MIN_COMPRESSION_LEVEL; }
Longtail_CompressionAPI_HSettings Longtail_GetZStdDefaultQuality() { return (Longtail_CompressionAPI_HSettings)&LONGTAIL_ZSTD_DEFAULT_COMPRESSION_LEVEL; }
Longtail_CompressionAPI_HSettings Longtail_GetZStdMaxQuality() { return (Longtail_CompressionAPI_HSettings)&LONGTAIL_ZSTD_MAX_COMPRESSION_LEVEL; }
