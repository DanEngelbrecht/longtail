...
int Longtail_CreateRWLock(void* mem, HLongtail_RWLock* out_rw_lock)
{
    ...
    InitializeSRWLock(&rw_lock->m_Lock);
    *out_rw_lock = rw_lock;
    return 0;
}
