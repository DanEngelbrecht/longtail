...
public:
    ...
    static int PreflightGet(struct Longtail_BlockStoreAPI* block_store_api, uint32_t chunk_count, const TLongtail_Hash* chunk_hashes, struct Longtail_AsyncPreflightStartedAPI* async_complete_api);
...
int TestAsyncBlockStore::PreflightGet(struct Longtail_BlockStoreAPI* block_store_api, uint32_t chunk_count, const TLongtail_Hash* chunk_hashes, struct Longtail_AsyncPreflightStartedAPI* async_complete_api)
{
    if (async_complete_api)
    {
        async_complete_api->OnComplete(async_complete_api, 0, 0, 0);
    }
    return 0;
}
...
TEST(Longtail, TestChangeVersionCancelOperation)
{
    ...
    struct BlockStoreProxy
    {
        ...
        {
            struct BlockStoreProxy* api = (struct BlockStoreProxy*)block_store_api;
            return api->m_Base->PreflightGet(api->m_Base, chunk_count, chunk_hashes, async_complete_api);
        }
        static int GetStoredBlock(struct Longtail_BlockStoreAPI* block_store_api, uint64_t block_hash, struct Longtail_AsyncGetStoredBlockAPI* async_complete_api)
        {
            struct BlockStoreProxy* api = (struct BlockStoreProxy*)block_store_api;
...
static int CaptureBlockStore_PreflightGet(struct Longtail_BlockStoreAPI* block_store_api, uint32_t block_count, const TLongtail_Hash* block_hashes, struct Longtail_AsyncPreflightStartedAPI* async_complete_api)
{
    struct CaptureBlockStore* api = (struct CaptureBlockStore*)block_store_api;
    ...
    return api->m_BackingStore->PreflightGet(api->m_BackingStore, block_count, block_hashes, async_complete_api);
}
...
static int CancelStore_PreflightGet(struct Longtail_BlockStoreAPI* block_store_api, uint32_t block_count, const TLongtail_Hash* block_hashes, struct Longtail_AsyncPreflightStartedAPI* async_complete_api)
{
    return ECANCELED;
}
