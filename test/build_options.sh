...
export SRC="$BASE_DIR/src/*.c $LIB_SRC $FILESTORAGE_SRC $MEMSTORAGE_SRC $MEOWHASH_SRC $BIKESHED_SRC $BLAKE2_SRC $BLAKE3_SRC $LIZARD_SRC $LZ4_SRC $BROTLI_SRC $ZSTD_SRC"
